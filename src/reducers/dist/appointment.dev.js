...
var _default = function _default() {
  ...
  switch (action.type) {
    case _appointment.ADD_APPOINTMENT:
      var newAppointment = new _appointment2["default"](new Date().toString(), action.appointmentData.date, action.appointmentData.slot, action.appointmentData.doctorId, action.appointmentData.hospitalId);
