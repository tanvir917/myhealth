...
import { View, Text, FlatList, Button, StyleSheet, ScrollView, Image, TouchableHighlight } from 'react-native';
...
const CheckAppointment = props => {
    ...
    return (
        ...
        <View style={{ overflow: 'visible', width: '90%', height: '100%', margin: '7%', flex: 1}}>
                <Card style={styles.Cardstyle}>
                    ...
                    <View style={{marginTop: 50, flexDirection: 'row', justifyContent: 'center', marginBottom: 40}}>
                        <ButtonCom 
                            title='Confirm'
                        ...
                        <ButtonCom
                            title = 'Cancel'
                            containerStyle={{marginLeft: 15, backgroundColor: 'red'}}
                            buttonSize={{height: 44, width: '30%'}}
                            onSelect={() => {
...
CheckAppointment.navigationOptions = (navData) => {
    return {
        headerTitle: 'Check Your Appointment',
        headerRight:
          () => 
          <TouchableHighlight 
